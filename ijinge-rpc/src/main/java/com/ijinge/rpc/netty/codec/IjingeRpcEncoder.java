...
public class IjingeRpcEncoder extends MessageToByteEncoder<Message> {
    ...
    protected void encode(ChannelHandlerContext ctx, Message msg, ByteBuf out) throws Exception {
        out.writeBytes(IjingeRpcConstants.MAGIC_NUMBER);
        out.writeByte(IjingeRpcConstants.VERSION);
        // 预留数据长度位置
        ...
        byte[] bodyBytes = null;
        //header 长度为 16
        int fullLength = IjingeRpcConstants.HEAD_LENGTH;
        ...
        out.writerIndex(writeIndex - fullLength + IjingeRpcConstants.MAGIC_NUMBER.length + 1);
